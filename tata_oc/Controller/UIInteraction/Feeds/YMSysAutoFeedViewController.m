...
#import "YMSysAutoFeedViewController.h"
#import "YMAutoFeedTableViewCell.h"

@interface YMSysAutoFeedViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView* tableView;
@property (nonatomic, strong) NSMutableArray<YMFeedModel*>* feeds;
@property (nonatomic, strong) NSArray* testCase;
@end

@implementation YMSysAutoFeedViewController
